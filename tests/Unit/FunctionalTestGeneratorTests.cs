...
public class FunctionalTestGeneratorTests
{
    ...
    public void GenerateFromFile_WithMinimalCrif_ProducesValidCode()
    {
        ...
        Assert.That(result, Does.Contain("public partial class MyFeature_Feature_Tests : TestBase"));
    ...
    public void GenerateFromSampleYaml_ProducesCompleteOutput()
    {
        ...
        var yamlPath = Path.Combine("SampleData", "sample-crif.yaml");
        ...
        Assert.That(generatedCode, Does.Contain("public partial class TransactionRecordFields_Feature_Tests : FunctionalTestBase"));
        ...
        TestContext.Out.WriteLine($"Generated test file: {Path.GetFullPath(outputPath)}");
    }
